...
moegliche_fehler = ("Offene Luftblasen",
                    "Luftblasen mit dem Finger fühlbar an der Vergussoberfläche",
                    "Luftblasen über dem LED-Band",
                    "Vergussmaterial über die LED gelaufen",
                    "Vergusshöhe mit Tiefenmesser falsch")
spannung = 12
strombereich1 = 340, 360
strombereich2 = 1040, 1060
...
# Save:
wb = xlsx.Workbook(realpath("Test1.xlsx"))
ws = wb.add_worksheet()
